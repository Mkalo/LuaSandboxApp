...
function setupSafeEnvironment()
	...
	-- Removing unsafe stuff from LuaSandboxEnvironment
	local unsafe = {"setupSafeEnvironment", "setTimeout", "_outputMessage", "collectgarbage", "dofile", "getmetatable", "load", "loadfile", "loadstring", "rawequal", "rawget", "rawset", "setfenv", "getfenv", "setmetatable", "module", "require", "package", "io", "debug", {"bit32"}, {"table"}, {"coroutine"}, {"math"}, {"os", "date", "execute", "exit", "getenv", "remove", "rename", "setlocale", "tmpname"}, {"string", "dump"}}
